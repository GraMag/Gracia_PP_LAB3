let personas = [{"id":1, "nombre":"Clark", "apellido":"Kent", "edad":45, "alterego":"Superman", "ciudad":"Metropolis",
...
let selected = document.getElementsByName("selectType");
let inputHeroe = document.getElementsByName("heroe");
let inputVillano = document.getElementsByName("villano");

selected.addEventListener("change", function(){
  if(selected.value === "Heroe"){
    inputHeroe.hidden = false;
    inputVillano.hidden = true;
  } else {
    inputHeroe.hidden = true;
    inputVillano.hidden = false;
  }
